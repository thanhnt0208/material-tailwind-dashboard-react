...
import { authorsTableData } from "@/data"; // hoặc projectsTableData nếu dùng bảng project
...
const Fram = () => {
  return (
    <div className="p-4 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      {/* Breadcrumb */}
      <div className="mb-4">
        <nav className="flex mb-5 text-sm font-medium" aria-label="Breadcrumb">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <form className="sm:pr-3 w-full sm:w-auto">
